...
public class Student{
    ...
    public static Student[] facultySelection(Student[] students, int faculty) throws FacultyCheckException {
        if(faculty != 1 && faculty != 2 && faculty != 3){
            throw new FacultyCheckException();
        }
        int count = 0;
    ...
    public static Student[] birthAfter(Student[] students, int year) throws YearCheckException {
        if(year > Calendar.getInstance().get(Calendar.YEAR)){
            throw new YearCheckException();
        }
        int count = 0;
        for (int i = 0; i < students.length; i++) {
    ...
    public static Student[] groupList(Student[] students, int group) throws GroupCheckException {
        if(group != 143 && group != 141 || group <= 0){
            throw new GroupCheckException();
        }
        int count = 0;
        for (int i = 0; i < students.length; i++) {
